      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-8">
            <span className="text-secondary-green">Ready to</span> <span className="text-primary-green">Innovate?</span>
          </h2>
          <p className="text-xl text-muted-foreground mb-8">
            Let's build the future together with cutting-edge technology solutions
          </p>
          
          <div className="glass-card border-primary-green rounded-xl p-8 max-w-2xl mx-auto">
            <Form {...form}>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          <SelectItem value="saas">SaaS Web Development</SelectItem>
                          <SelectItem value="ai">AI/ML Innovation</SelectItem>
